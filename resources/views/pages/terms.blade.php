...
<div class="tile is-parent is-vertical is-3">
    ...
    <div class="tile is-parent is-vertical is-9">
        ...
        <div class="content">
                  <h1>1. How Personal Information about Customers is used?</h1>
          User data may be shared with Pharmnamics providers to improve order processing and customer service. It may also be used both for marketing research purposes and customer relation management, it being specified that some of those providers are not located in the European Union.
          ...
          By completing an order or signing up, you agree to receive a) emails associated with finalizing your order, which may contain relevant offers from third parties, and b) emails asking you to review Pharmnamics and your purchase and c) promotional emails, SMS and push notifications from Pharmnamics. You may unsubscribe from promotional emails via a link provided in each email. If you would like us to remove your personal information from our database, unsubscribe from emails and/or SMS, please email Customer Service email address by country

         <h1> 2. What about Cookies?</h1>
          ...
          Pharmnamics uses Google Analytics and Webtrekk GmbH (Click Here) for marketing and personal data optimization purposes. Pharmnamics also uses Google Digital Marketing to propose targeted offers.
          To find out more:

          About Google Analytics: Click Here
          About Webtrekk GmbH: Click Here
          About Google Digital Marketing: Click Here

         <h1> 3. What is the accuracy of the Personal Data provided to Pharmnamics? </h1>
